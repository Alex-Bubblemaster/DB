namespace MySql
{
    ...
    public class Startup
    {
        ...
        {
            // It needs permission and logi information for it to work so you will get a big bang if you try to run it before that..
            ...
            using (dbConnection)
            {
                int newBookOne = AddNewBookToDBTable(dbConnection, "JavaScript Object Oriented Programming", "Zakas", DateTime.Parse("2015.11.10"), 1234567890123);
                int newBookTwo = AddNewBookToDBTable(dbConnection, "How to be a millionair", "Some stoopid author", DateTime.Parse("2015.12.10"), 1234567890123);
                Console.WriteLine("Inserted new product with Id: {0}", newBookOne);
                Console.WriteLine("Inserted new product with Id: {0}", newBookTwo);
